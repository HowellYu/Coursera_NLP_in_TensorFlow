# -*- coding: utf-8 -*-
"""Course 3 - Week 1 - Lesson 2 - TexttoSeq - Pad.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1BVsYApT5LzN18tZGQo7ZzFnYLL5xhj7v
"""
...
tokenizer = Tokenizer(num_words = 100, oov_token="<OOV>") # oov for out-of-vocab
...
padded = pad_sequences(sequences, 
                       padding='post', # add OOV to the end 
                       truncating='post', # lose info from the end 
                       maxlen=5)
